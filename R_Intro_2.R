...
# There are many packages with useful functions that can be downloaded, installed and loaded. Most useful packages to install: "lmodel2", "ncdf", "fields", "maps", "spam", "abind", "mnormt".
...
# *** Another very useful package is "ncdf", which has functions that can read and write NetCDF data format, a widely used format in meteorological and climatological data. E.g., you can download assimilated meteorological data in nc format worldwide from: http://www.esrl.noaa.gov/psd/data/gridded/data.ncep.reanalysis.html
...
# Set working directory:
	setwd('D:/R-Programming/sujanojha/codesfromprofessor')
